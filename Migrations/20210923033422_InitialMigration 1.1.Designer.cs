...
namespace Interview.Infrastructure.Migrations
{
    ...
    [Migration("20210923033422_InitialMigration 1.1")]
            ...
            modelBuilder.Entity("MasterProject.Core.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("15789274-a08e-4ccb-a149-bde633421026"),
                            CreatedOn = new DateTime(2021, 9, 22, 23, 34, 22, 113, DateTimeKind.Local).AddTicks(3151),
                            Name = "ABC Client"
                        });
                });
